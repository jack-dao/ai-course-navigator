...
const AboutTab = ({ onOpenPrivacy }: AboutTabProps) => {
  return (
    <div className="flex-1 h-full overflow-y-auto bg-white p-8 md:p-12 flex flex-col">
      <div className="max-w-3xl mx-auto space-y-12 pb-10 flex-1">
        <div className="text-center space-y-6">
          <h1 className="text-4xl font-black text-ucsc-blue tracking-tight">AI Slug Navigator</h1>
          <p className="text-xl text-slate-600 font-medium leading-relaxed max-w-2xl mx-auto">
            The smartest way for UC Santa Cruz students to search classes, check ratings, and build schedules.
          </p>

          <div className="flex items-center justify-center gap-6 text-ucsc-blue font-bold text-sm">
        ...
        <div className="bg-slate-50 rounded-3xl p-8 border border-slate-200">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-ucsc-gold text-ucsc-blue rounded-xl flex items-center justify-center">
              <Info className="w-6 h-6" />
            </div>
            <h2 className="text-xl font-bold text-ucsc-blue">How Sammy AI Works</h2>
          </div>

          <p className="text-slate-700 font-medium leading-relaxed mb-6">
            Sammy acts as your personal academic assistant. It scans the entire UCSC catalog to find classes that fit
            your needs, checks for time conflicts with your current schedule, and pulls in{' '}
            <strong>RateMyProfessors</strong> data to help you find the best instructors.
          </p>

          <div className="flex gap-3 p-4 bg-white rounded-xl border border-slate-200 text-sm text-slate-600 shadow-sm">
            <AlertTriangle className="w-5 h-5 text-ucsc-gold shrink-0" />
            <p>
              <strong>Heads up:</strong> Course availability is updated nightly. Additionally, Sammy is an AI and can
              occasionally make mistakes. Always verify the live status and details in MyUCSC before enrolling.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={i}
                className="p-4 rounded-2xl border border-slate-100 bg-white shadow-sm flex flex-col items-center text-center"
              >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="p-6 rounded-3xl border border-slate-200 hover:border-emerald-200 transition-colors bg-white">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              We use <strong>Supabase</strong> (Google Login) to securely authenticate you. We only store your saved
              schedules so you can access them later. We <strong>do not</strong> sell your data or access your personal
              UCSC accounts.
            </p>
          </div>
          ...
          <div className="p-6 rounded-3xl border border-slate-200 hover:border-blue-200 transition-colors bg-white">
            ...
            <p className="text-sm text-slate-600 leading-relaxed">
              Course data comes from publicly available UCSC schedule listings. Professor ratings are sourced from{' '}
              <strong>RateMyProfessors</strong>. This application is not affiliated with, endorsed by, or connected to
      ...
      <div className="border-t border-slate-100 pt-8 mt-4 flex flex-col items-center justify-center gap-3 text-xs font-bold text-slate-400">
        ...
        <button
          ...
          className="hover:text-ucsc-blue transition-colors cursor-pointer hover:underline"
        >
          Privacy Policy
        </button>
      </div>
