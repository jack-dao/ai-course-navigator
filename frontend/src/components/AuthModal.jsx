        ...
        <div className="flex-1 p-8 md:p-12 bg-white relative">
            ...
            <div className="max-w-sm mx-auto h-full flex flex-col justify-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <button type="submit" disabled={loading} className="w-full bg-[#003C6C] text-white font-bold py-3.5 rounded-xl hover:bg-[#002a4d] transition-all flex items-center justify-center gap-2 shadow-lg shadow-blue-900/10 active:scale-[0.98] mt-2 cursor-pointer">
