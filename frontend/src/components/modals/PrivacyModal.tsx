      ...
      <div className="relative bg-white w-full max-w-2xl max-h-[85vh] rounded-[32px] shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-4 duration-300">
        ...
        <div className="flex-1 overflow-y-auto p-8 custom-scrollbar bg-white space-y-8">
          <section className="space-y-3">
            <h3 className="text-lg font-bold text-ucsc-blue flex items-center gap-2">
              <Eye className="w-5 h-5" /> 1. Information We Collect
            </h3>
            <p className="text-sm text-slate-600 leading-relaxed ml-7">
              When you sign in with Google, we collect your <strong>email address</strong> and <strong>name</strong>{' '}
              solely for authentication purposes. We also store the <strong>schedules</strong> you voluntarily create
              and save within the application.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-sm text-slate-600 leading-relaxed ml-7">Your data is used strictly to:</p>
